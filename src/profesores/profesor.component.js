...
class Profesor extends Component {
    ...
    handleClick = (event,id) => {
        console.log(id);
        const {dispatch} = this.props;
        dispatch(profesorAction.deleteProfesorById(id))
    };

    render() {
        const {classes} = this.props;
        const {profesor} = this.props.profesor;
                                                ...
                                                <TableRow key={n._id}>
                                                    ...
                                                    <TableCell>
                                                        <IconButton className={classes.button} aria-label="Edit"
                                                                    component='a' href={`/edit-profesor/${n._id}`}>
                                                            <EditIcon/>
                                                        </IconButton>
...
const connectedProfesorPage = withRouter(connect(mapStateToProps,null,null,{
    pure: false
})(withStyles(styles)(Profesor)));

export {connectedProfesorPage as Profesor};